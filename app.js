...
var fs = require('fs')
var logger = fs.createWriteStream('report-Silvasilvasi.txt', {
...
function BOMBA(tweet) {
	...
	if ( tweet.user.screen_name !== 'Silvasilvasi' ) {
...
var stream = T.stream('statuses/filter', { follow:  ( '908409030799851520 , 949964714125201413 , 930320920861745153 , 931731798186377216 , 837568377749180416 , 955765875428163584 , 950165227731017729 , 942672513104007168 , 910869642368966657 ,	930801214182260737 , 962547978803302400 , 3345461817 , 961623007218290688 , 2230396922 , 900442763598192641 , 928665122645692416 , 934374469698588673 , 912476913318346753 , 956678839563931648 , 914254996182532096 , 960648946271039488 , 927929016111325188 , 807999107365273600 , 960884349980893184 , 954770824501911552 , 938127831820881920 , 936204840878866432 , 913327957904695297 , 929817868673437697 , 879588404693827585 , 2351528224 , 943622133506347008 , 928375322017382401 , 887925114100043776 , 174606919, 953264830454095872 , 888326326284890113 , 957565773387616256 , 950095434952921090 ' ) });
